...
export class ReporterRuntime {
  constructor(_ref) {
    ...
    _defineProperty(this, "startScope", function () {
      ...
      return _this.startScopeWithUuid(randomUuid(), opts);
    });
    ...
    _defineProperty(this, "startFixture", function (type, fixtureResult) {
      ...
      var uuid = randomUuid();
      var wrappedFixture = _this.state.setFixtureResult(uuid, type, _objectSpread(_objectSpread({}, createFixtureResult()), {}, {
        start: Date.now()
      }, fixtureResult));
    ...
    _defineProperty(this, "stopTest", function () {
      ...
      (_targetResult$testCas = targetResult.testCaseId) !== null && _targetResult$testCas !== void 0 ? _targetResult$testCas : targetResult.testCaseId = getTestResultTestCaseId(targetResult);
      (_targetResult$history = targetResult.historyId) !== null && _targetResult$history !== void 0 ? _targetResult$history : targetResult.historyId = getTestResultHistoryId(targetResult);
