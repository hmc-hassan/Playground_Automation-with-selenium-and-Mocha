...
class LifecycleState {
  constructor() {
    ...
    _defineProperty(this, "getWrappedFixture", uuid => this.fixturesResults.get(uuid));
    _defineProperty(this, "getFixture", uuid => {
      var _this$getWrappedFixtu;
      return (_this$getWrappedFixtu = this.getWrappedFixture(uuid)) === null || _this$getWrappedFixtu === void 0 ? void 0 : _this$getWrappedFixtu.value;
    });
    _defineProperty(this, "getTest", uuid => this.testResults.get(uuid));
    _defineProperty(this, "getStep", uuid => this.stepResults.get(uuid));
