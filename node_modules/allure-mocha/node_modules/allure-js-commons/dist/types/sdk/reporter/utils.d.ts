...
export declare const getWorstStepResultStatusPriority: (steps: StepResult[], priority?: number) => number | undefined;
export declare const getWorstStepResultStatus: (steps: StepResult[]) => Status | undefined;
...
export declare const stringifyProperties: typeof properties.stringify;
